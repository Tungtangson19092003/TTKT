...
#define _39_IICA_LOW_WIDTH                            (0x39U) /* set the low-level width (tLOW) of the SCLA0 pin signal */
#define _40_IICA_HIGH_WIDTH                           (0x40U) /* set the high-level width of the SCLA0 pin signal */
