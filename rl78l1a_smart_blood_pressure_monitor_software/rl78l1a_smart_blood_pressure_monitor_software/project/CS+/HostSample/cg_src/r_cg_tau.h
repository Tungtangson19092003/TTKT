...
#define _095F_TAU_TDR06_VALUE                 (0x095FU) /* 16-bit timer data register 06 */
#define _0690_TAU_TDR07_VALUE                 (0x0690U) /* 16-bit timer data register 07 */
/* Clock divisor for TAU0 channel 0 */
#define TAU0_CHANNEL0_DIVISOR             (8U)      /* fCLK/2^3 */
/* Clock divisor for TAU0 channel 6 */
#define TAU0_CHANNEL6_DIVISOR             (1U)      /* fCLK */
/* Clock divisor for TAU0 channel 7 */
#define TAU0_CHANNEL7_DIVISOR             (1U)      /* fCLK */
