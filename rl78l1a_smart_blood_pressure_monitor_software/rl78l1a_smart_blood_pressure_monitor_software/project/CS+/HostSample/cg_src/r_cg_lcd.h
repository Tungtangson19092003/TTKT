...
#define _00_LCD_VOLTAGE_NOTCONTROL         (0x00U) /* initialization of voltage boosting pin is not controlled */
#define _01_LCD_VOLTAGE_CONTROL            (0x01U) /* initialization of voltage boosting pin is controlled */
