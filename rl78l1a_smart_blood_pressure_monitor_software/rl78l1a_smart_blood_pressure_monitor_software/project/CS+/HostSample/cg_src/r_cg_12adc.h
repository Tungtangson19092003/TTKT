...
#define _0200_AD_SELF_DIAGNOSIS_1_2_V                   (0x0200U) /* uses the voltage of reference power supply ¡Á 1/2 for self-diagnosis */
...
Macro definitions
***********************************************************************************************************************/
#define _58_AD_SAMPLE_STATE6_VALUE                      (0x58U) /* A/D sampling state register 6 */
#define _0040_AD_ADANSA0_GUI_VALUE                      (0x0040U)
